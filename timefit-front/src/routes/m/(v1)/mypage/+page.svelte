            ...
            <div class="card bg-base-100 border-base-200 border shadow-lg">
                <div class="card-body p-6">
                    <div class="mb-6 flex items-start justify-between">
                        <div class="flex-1">
                            <h2 class="text-base-content mb-1 text-xl font-semibold">
                                {userProfile.name}
                            </h2>
                            <p class="text-base-content/70 mb-1 text-sm">{userProfile.email}</p>
                            <p class="text-base-content/70 text-sm">{userProfile.phone}</p>
                        </div>

                        <div class="avatar">
                            <div
                                class="bg-base-200 flex h-16 w-16 items-center justify-center rounded-full"
                            >
                    ...
                    <div class="card-body p-4">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap-3">
                                ...
                                <span class="text-base-content font-medium">Google</span>
                            </div>
                ...
                <div class="card bg-base-100 border-base-200 border shadow-sm">
                    <div class="card-body p-4">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap-3">
                                <div
                                    class="flex h-10 w-10 items-center justify-center rounded-full bg-yellow-400"
                                >
                                    <span class="text-sm font-bold text-black">kakao</span>
                                </div>
                                <span class="text-base-content font-medium">Kakao</span>
                            </div>
                    ...
                    <div class="card-body p-4">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap-3">
                                ...
                                <span class="text-base-content font-medium">Apple</span>
                            </div>
