  ...
  return (
    <div className="flex flex-col bg-white px-4 py-8">
      ...
      <div className="flex flex-col items-center text-center">
        ...
        <h1 className="mt-4 text-xl font-bold text-gray-900">예약이 완료되었습니다!</h1>
        <p className="mt-2 text-sm text-gray-500">
          예약 번호: <span className="font-semibold text-[#3ec0c7]">{reservationData.reservationNumber}</span>
        </p>
      </div>
      ...
      <div className="mt-8 rounded-2xl border border-gray-100 bg-gray-50 p-4">
        ...
        <div className="mb-4 pb-4 border-b border-gray-200">
          <p className="font-semibold text-gray-900">{reservationData.placeName}</p>
        ...
        {/* 날짜 및 시간 */}
        <div className="mb-4 flex gap-6 pb-4 border-b border-gray-200">
          <div className="flex items-center gap-2">
            <Calendar className="h-4 w-4 text-[#3ec0c7]" />
            <span className="text-sm text-gray-700">{reservationData.date}</span>
          </div>
          <div className="flex items-center gap-2">
