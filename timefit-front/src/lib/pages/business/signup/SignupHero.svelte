<div
	class="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-info to-success p-12 items-center justify-center"
>
		...
		<div class="mb-8">
			<div class="w-16 h-16 bg-white/20 rounded-full flex items-center justify-center mb-6">
				<svg class="w-8 h-8" fill="currentColor" viewBox="0 0 20 20">
					...
					<path
						fill-rule="evenodd"
						d="M4 4a2 2 0 00-2 2v8a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2H4zm0 2v2h12V6H4zm0 4v4h12v-4H4z"
						clip-rule="evenodd"
					/>
				</svg>
			</div>
			...
			<p class="text-xl opacity-90 mb-8">
				팀과 조직을 위한 스마트한 시간 관리 솔루션으로 업무 효율성을 극대화하세요.
			</p>
		</div>
