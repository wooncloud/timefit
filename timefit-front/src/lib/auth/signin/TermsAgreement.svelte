<script lang="ts">
    export let termsUrl: string = '/terms';
    export let privacyUrl: string = '/privacy';
    export let text: string = '계속 진행하면';
    export let termsText: string = '이용약관';
    export let privacyText: string = '개인정보처리방침';
