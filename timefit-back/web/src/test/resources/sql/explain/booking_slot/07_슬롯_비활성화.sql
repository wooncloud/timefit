...
-- 슬롯 비활성화
-- ============================================================
-- API:        PATCH /api/business/{id}/booking-slot/{sid}/deactivate
-- 핵심 쿼리:  UPDATE booking_slot SET is_active = false WHERE id = ?
...
--    - 인덱스가 is_active를 포함하지 않으면 인덱스 갱신 불필요
--
-- 비교: 여러 컬럼 변경하는 UPDATE보다 cost 낮음
