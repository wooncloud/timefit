...
import timefit.common.swagger.operation.businesscategory.*;
import timefit.common.swagger.requestbody.businesscategory.*;
...
public class BusinessCategoryController {
    ...
    public ResponseEntity<ResponseData<BusinessCategoryResponseDto.Category>> createCategory(
            @PathVariable UUID businessId,
            @CreateCategoryRequestBody @Valid @RequestBody BusinessCategoryRequestDto.CreateCategory request,
    ...
    public ResponseEntity<ResponseData<BusinessCategoryResponseDto.Category>> updateCategory(
            @PathVariable UUID businessId,
            @PathVariable UUID categoryId,
            @UpdateCategoryRequestBody @Valid @RequestBody BusinessCategoryRequestDto.UpdateCategory request,
            @Parameter(hidden = true) @CurrentUserId UUID currentUserId) {
